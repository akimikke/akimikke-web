...
const faqs = [
    {
        question: "掲載費はかかりますか？",
        answer:
            "現在、AkiMikkeへの施設情報掲載は無料です。掲載費用はかかりません。",
    },
    {
        question: "掲載後に情報を修正できますか？",
        answer:
            "はい。事業所登録フォームの「情報更新」から、空き状況や施設情報のリアルタイム更新が可能です。",
    },
    {
        question: "施設写真は掲載できますか？",
        answer:
            "はい。施設の外観・室内・活動風景などの写真を掲載できます。",
    },
    {
        question: "掲載までどれくらいかかりますか？",
        answer:
            "登録フォームで送信後、完了表示が出ましたら公開されます。ただし、文字化けや不明瞭な内容が確認された場合、事務局からご連絡する場合があります。",
    },
];
